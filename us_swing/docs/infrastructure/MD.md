...
| MD-INF-007.001.M03 | SRD-INF-007.006 | `src/us_swing/core/symbols.py` | Vendor symbol notation for class shares, shared across GUI/EXE/universe so no tool reaches into another | `yahoo_symbol()` | — | No | Draft |
